...
const Navbar = () => {
 ...
 return (
    <header className='bg-red-200 text-white py-0 px-4 fixed top-0 left-0 right-0 z-10'>
      <div className='container mx-auto flex justify-between items-center h-full'>
           ...
           {/* button */}
            <div className='hidden md:block'>
              ...
              href="#contact" className='text-white bg-blue-950 hover:bg-blue-950 px-4 py-2 rounded'>
                Contact Us
                </a> 
                </div>
                {/* hamburger menu*/}
               ...
               isOpen &&(
                    <nav className='absolute top-full left-0 w-full bg-heroBg z-20 md:hidden'>
                       <ul className='flex flex-col p-4 space-y-3'>
                          ...
                          <li className='py-2'>
                          <a href="#contact"
                          className='text-white bg-sky-950 hover:bg-blue-900 px-4 py-2 rounded'
                          onClick={(e) =>  {
                            e.preventDefault();
                            handleCloseMenu();
                            handleScrollTo('contact')
