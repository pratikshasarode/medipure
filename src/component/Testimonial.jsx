...
const Testimonial = () => {
  return (
    <div className='bg-[#f7f8fc] py-12' id='testimonial'>
      ...
      <p className='text-lg mb-12 md:w-1/2 mx-auto'>Here from some of our staisfied clients about how our Services have positively impacted their lives and well-being</p>
        </div>
        <div className='flex flex-col md:w-4/5 mx-auto md:flex-row md:gap-12 gap-8'>
          {
               testimonial.map((testimonial, index) => (
                <div key={index} className='relative bg-white rounded-lg p-6 flex-1'>
                   ...
                   <BsChatQuoteFill className='size-12 text-red-300' />
                   </div>
                    <div className='flex flex-col space-y-3 mb-4'>
                      <p className='test-lg mb-2'>{testimonial.review}</p>
