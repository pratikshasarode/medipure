    ...
    <div className='bg-[#f7f8fc] pt-32' id='pricing'>
     <div className='container mx-auto px-8'>
      <div className='text-center mb-12'>
          ...
          <p className='text-lg mb-12 md:w-2/3 mx-auto'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Architecto, culpa tempore necessitatibus maxime sed quo voluptas cumque</p>
      </div>
      ...
      <div className='flex flex-col md:w-5/6 mx-auto md:flex-row gap-8 mb-12'>
         {
              packages.map((pkg,  index) => (
                <div key={index} className='bg-white rounded-lg p-6 flex-1 shadow-lg'>
                      ...
                      <hr className='w-24 border text-red-200 border-red-300' />
                      ...
                      className='bg-red-200 text-white px-4 py-2 rounded'>Get Started</button>
                </div>
              ))
         }
      </div>
